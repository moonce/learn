...
import com.moonce.learn.util.TimeUtils;
...
public class TwoSum {
     ...
     *
     * 复杂度分析：
     * 时间复杂度：O(n<sup>2</sup>)， 对于每个元素，我们试图通过遍历数组的其余部分来寻找它所对应的目标元素，这将耗费 O(n) 的时间。因此时间复杂度为 O(n<sup>2</sup>)。
     * 空间复杂度：O(1)。
     * @param nums
     * @param target
     * @return
    ...
    public static void main(String[] args) {
        ...
        twoSum2(nums,target);
        consumingTime = TimeUtils.getNewDateTime() - startTime;
        System.out.println("twoSum2耗时:"+(consumingTime));
